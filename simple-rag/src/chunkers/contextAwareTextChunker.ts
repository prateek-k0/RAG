...
export class SectionAwareChunker {
  ...
  async chunk(
    ...
    for (const page of pages) {
      ...
      // make sure to include the source file name in the metadata, as it is used to identify the source of the chunk
      ...
      if (matches[0].index > 0) {
        // index is the startIndex of the pattern matched
